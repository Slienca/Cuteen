...
var paragraph = new Gravity('heading');
var gravity = new Gravity('subheading');

var button = document.querySelector('.hero-box.d-flex.justify-content-center.align-items-center.flex-column');
